...
[فونت‌فورج](https://fontforge.github.io) را که نصب کردید به سراغ یکی از صفحات فونت های آزاد رفته و پس از دریافت فایل سورس، آن را توسط فونت‌فورج باز کنید. برای شروع شاید [قلم وزیر](https://github.com/rastikerdar/vazir-font/raw/master/source/Vazir.sfd) بد نباشد.

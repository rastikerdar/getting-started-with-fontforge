...
[![گلیف دال](images/dal.png "گلیف دال")](images/dal.png)
...
- برای بزرگ و کوچک‌نمایی نیز کلیدهای ctrl+= یا از آن بهتر ctrl+غلتک موشی استفاده نمایید. (mouse=موشی)
- برای بالا و پایین حرکت دادن صفحه فقط غلتک موشی.
- برای چپ و راست بردن صفحه نیز shift+غلتک موشی.

- برای Undo یعنی بازگشت با به حالت قبل از آخرین تغییر در گلیف و یا Redo یعنی رفتن به حالت پس از تغییر بعدی به ترتیب دکمه های ctrl+Z و ctrl+Y را هرگز فراموش نکنید.
...
[![کناره‌ها](images/sides.png "کناره‌ها")](images/sides.png)
...
[![خطوط کمکی](images/guide-lines.png "خطوط کمکی")](images/guide-lines.png)
...
### گره محنی اچ وی یا افقی و عمودی یا H/V Curve point
...
[![طراحی صحیح](images/right-design.png "طراحی صحیح")](images/right-design.png)


## کار با گره‌ها
در جعبه ابزار این چهار نوع گره را مشاهده می‌کنید. هر گاه که قصد داشتید گره‌ای را بر روی یک خط ایجاد کنید کافیست یکی از این چهار نوع را انتخاب نموده و در نقطه مورد نظر کلیک کنید. برای خروج از حالت ایجاد گره و بازگشتن به حالت انتخاب گره کلید V (وی انگلیسی) را فشار دهید یا دکمه موشی در جعبه ابزار را انتخاب کنید.
...
بعد از انتخاب گره‌های مورد نظر و سپس انتخاب این دکمه، کافیست موشی را به هر جایی که می‌خواهید تغییر اندازه انجام شود برده و بکشید. برای مثال اگر می‌خواهید گردی حرف واو از چپ کشیده‌تر شود موشی را به سمت راست گردی برده و به چپ بکشید. اگر می‌خواهد از هر دو جهت باشد در وسط قرار داده و بکشید. اگر می‌خواهید یکسان و در چهار جهت به یک اندازه بزرگ یا کوچک گردد همزمان کلید shift را نیز نگه دارید.
...
[![تصحیح جهت](images/correct-direction-before.png "تصحیح جهت")](images/correct-direction-before.png)
...
**سوال**: چرا در بسیاری از گلیف ها عناصر را نمی توان ویرایش کرد مثلا در گلیف ذال امکان ویرایش نقطه یا دال را وجود ندارد؟
...
این پیشروی‌ها نواحی اتصال حروف به یکدیگر می‌باشند. دلیلش اطمینان از اینست که گلیف‌های متصل به هم به نوعی در یکدیگر فرو رفته‌اند. این مقدار حتما باید کم یا جزئی باشد.

نکته: ضخامت خط پایه یا به عبارتی آن قسمتی که از گلیف که بر روی خط پایه قرار می گیرد حتما در همه حروف یکسان باشید.
...
[![ایجاد فونت](images/generate-fonts-1.png "ایجاد فونت")](images/generate-fonts-1.png)

[![ایجاد فونت](images/generate-fonts-2.png "ایجاد فونت")](images/generate-fonts-2.png)

[![ایجاد فونت](images/generate-fonts-3.png "ایجاد فونت")](images/generate-fonts-3.png)
...
این فایل با فرمت html را دریافت و ذخیره نمایید. سپس با یک برنامه ویرایشگر فایل متنی یا html، واژه myfont را با نام فونت مورد نظر خود جایگزین نموده و ذخیره کنید. فایل فونت خود با پسوند woff یا ttf را در کنار این فایل html (همان پوشه) ذخیره و در نهایت فایل html را با یک ویرایشگر باز نمایید. هر بار که فایل فونت خود را generate یا تولید کردید این صفحه را مجددا ببینید (refresh).
...
مجوز این متن: GNU Free Documentation License
